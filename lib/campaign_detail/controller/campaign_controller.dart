...
final fetchCampaignProvider = FutureProvider.family<DonateCampaign, String>(
  (ref, id) => _defaultCampaign,
);

final campaignControllerProvider =
    StateNotifierProvider.family<CampaignController, DonateCampaign, String>(
        (ref, campaignId) {
